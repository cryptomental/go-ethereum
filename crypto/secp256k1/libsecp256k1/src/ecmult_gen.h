...
typedef struct {
     ...
     */
    xsecp256k1_ge_storage (*prec)[64][16]; /* prec[j][i] = 16^j * i * G + U_i */
    xsecp256k1_scalar blind;
    xsecp256k1_gej initial;
} xsecp256k1_ecmult_gen_context;
...
static void xsecp256k1_ecmult_gen(const xsecp256k1_ecmult_gen_context* ctx, xsecp256k1_gej *r, const xsecp256k1_scalar *a);
